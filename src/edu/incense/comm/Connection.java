...
public abstract class Connection {
	...
	protected void setPathsFromResource(){
		httpClientId = context.getResources().getString(R.string.http_client_id);
	}
	
	protected enum ConnectionType { INPUT, OUTPUT, BOTH }
	
	protected boolean connect(String serverAddress, ConnectionType connectionType, String contentType){
		connection = null;
		try {
			Log.i(getClass().getName(), "Trying to stablish connection to"+serverAddress+"...");
			...
			if(connectionType == ConnectionType.INPUT || connectionType == ConnectionType.BOTH){
			...
			if(connectionType == ConnectionType.OUTPUT || connectionType == ConnectionType.BOTH){
