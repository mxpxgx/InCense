...
public abstract class Sensor{
	...
	private int periodTime; 		//Sleep time for each cycle (period time in milliseconds)
	...
	public float getSampleFrequency(){ return sampleFrequency; }
	protected int getPeriodTime(){ return periodTime; }
}
