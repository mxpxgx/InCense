...
public class AccelerometerSensor extends edu.incense.sensor.Sensor implements SensorEventListener {
	...
	@Override
	public void start(){
		boolean success = sm.registerListener(this, accSensor, SensorManager.SENSOR_DELAY_NORMAL);//getPeriodTime());
		if(success) System.out.println("SensorEventLister registered!!!");
		else System.out.println("SensorEventLister NOT registered!!!");
		super.start();
	}
