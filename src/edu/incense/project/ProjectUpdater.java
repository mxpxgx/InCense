...
/***
 * ProjectUpdaterService runs automatically and check if there is a new version
 * of the project assigned to this application In case there is a new project,
