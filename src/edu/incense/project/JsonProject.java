...
public class JsonProject {
	...
	public ProjectSignature getProjectSignature(File signatureFile){
		...
		try {
			...
			List<TaskType> sensors = mapper.readValue(attribute, new TypeReference<List<TaskType>>() { });
	...
	public Project getProject(File projectFile){
		...
		try {
			...
			Map<String,JsonNode> map = mapper.readValue(attribute, new TypeReference<Map<String,JsonNode>>() { });
