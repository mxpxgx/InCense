...
public class SettingsActivity extends PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bluetoothCheckBoxPreference = (CheckBoxPreference) getPreferenceScreen().findPreference("checkboxBluetooth");
		bluetoothCheckBoxPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
		...
		CheckBoxPreference gpsCheckBoxPreference = (CheckBoxPreference) getPreferenceScreen().findPreference("checkboxGps");
		gpsCheckBoxPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
		...
		wifiCheckBoxPreference = (CheckBoxPreference) getPreferenceScreen().findPreference("checkboxWifi");
		wifiCheckBoxPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
	...
	private void verifyBluetooth(){
		boolean isBluetoothOn = sharedPreferences.getBoolean("checkboxBluetooth",false);
	...
	/*
	private void setSensorOff(String sensorName){
	...
	private void setWifiOff(){
		setSensorOff("checkboxWifi");
	}
	
	private void setBluetoothOff(){
		setSensorOff("checkboxBluetooth");
	}*/
