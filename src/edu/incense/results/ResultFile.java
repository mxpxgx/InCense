...
public class ResultFile {
	...
	public static ResultFile createInstance(Context context, FileType fileType){
		...
		case DATA:
			...
			extension = context.getResources().getString(R.string.results_data_extension);
			break;
		case AUDIO:
			...
			extension = context.getResources().getString(R.string.results_audio_extension);
			break;
		case SURVEY:
			parent = context.getResources().getString(R.string.results_survey_parent);
			child = context.getResources().getString(R.string.results_survey_child);
			extension = context.getResources().getString(R.string.results_survey_extension);
			break;
		}
	...
	public static ResultFile createDataInstance(Context context,  String extraName){
		long timestamp = System.currentTimeMillis();
		String parent="./";
		String child="data";
		String extension=".json";
