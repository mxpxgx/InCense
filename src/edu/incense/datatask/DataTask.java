...
public abstract class DataTask implements Runnable{
	...
	private int periodTime = 10000;	//Sleep time for each cycle (period time in milliseconds)
	...
	protected void clearInputs(){
		if(inputs != null) inputs.removeAll(inputs);
		inputs = new ArrayList<Input>();
	}
	
	protected void clearOutputs(){
		if(outputs != null) outputs.removeAll(outputs);
	...
	protected float getSampleFrequency(){ return sampleFrequency; }
