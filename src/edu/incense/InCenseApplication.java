...
public class InCenseApplication extends Application {
    private static InCenseApplication singleton; // Static singleton of this
                                                 // application
    private SurveyController surveyController; // Temporary SurveyController
                                               // reference to be started
