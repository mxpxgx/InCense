...
public class JsonSurvey {
	...
	public Survey toSurvey(JsonNode root){
		...
		try {
			...
			List<Question> questions = mapper.readValue(attribute, new TypeReference<List<Question>>() { });
			if(questions != null)
				survey.setQuestions(questions);
			else{
				Log.i(getClass().getName(), "Questions JSON node was empty/null or doesn't exist");
			}
